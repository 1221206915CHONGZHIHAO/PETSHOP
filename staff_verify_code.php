...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['otp'])) {
    $user_otp = $_POST['otp'];
    $session_otp = $_SESSION['staff_otp'] ?? null;

    if ($user_otp == $session_otp) {
        $_SESSION['staff_verified'] = true;
...
<head>
    ...
    <title>Verify OTP - Pet Shop Staff</title>
...
<div class="container">
    <div class="verify-container">
        ...
        <div class="otp-instruction">
            ...
            <div>
                We've sent a 6-digit code to <strong><?= isset($_SESSION['staff_email']) ? htmlspecialchars($_SESSION['staff_email']) : 'your email' ?></strong>. Check your inbox and spam folder.
            </div>
        </div>
        ...
        <div class="text-center mt-3">
            <a href="staff_forgot_password.php" class="back-link">
